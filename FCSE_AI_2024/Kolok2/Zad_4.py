...
if __name__ == '__main__':
    ...
    crit = input()
    test = input().split()
    test = [float(el) for el in test]

    clf = RandomForestClassifier(criterion=crit, n_estimators=n_trees, random_state=0)

    dataset = nu.delete(dataset, col_to_remove, 1)
    ...
    test = nu.delete([test], col_to_remove, 1)
